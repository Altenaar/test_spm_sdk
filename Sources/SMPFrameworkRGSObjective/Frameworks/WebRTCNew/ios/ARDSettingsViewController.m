...
- (void)selectCurrentlyStoredOrDefaultMediaConstraints {
	NSString *currentSelection = [_settingsModel currentVideoResolutionSettingFromStore];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
	if ([self sectionIsMediaConstraints:(int)section]) {
...
- (BOOL)indexPathIsMediaConstraints:(NSIndexPath *)indexPath {
	return [self sectionIsMediaConstraints:(int)indexPath.section];
}

- (BOOL)indexPathIsBitrate:(NSIndexPath *)indexPath {
	return [self sectionIsBitrate:(int)indexPath.section];
}
...
- (nullable NSString *)tableView:(UITableView *)tableView
	...
	if ([self sectionIsBitrate:(int)section]) {
