...
@property(nonatomic, strong) ARDSignalingMessage *messageAnswer;
@property(nonatomic, strong) ARDSignalingMessage *messageOffer;
...
@property(nonatomic, assign) BOOL useMediaServer;
...
@property(nonatomic, readonly) BOOL audioConnect;

@property(nonatomic, strong) RTCRtpSender *defaultAudioSender;
@property(nonatomic, strong) RTCRtpSender *defaultVideoSender;
